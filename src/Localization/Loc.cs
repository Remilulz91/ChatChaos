    ...
    public static class Loc
    {
        ...
        private static void Build()
        {
            _strings[Lang.English] = new Dictionary<string, string>
            {
                ...
                ["chat.random_event"]  = "Random event launched: {0}",
                ...
                ["fx.timefreeze"]          = "Time frozen",
                ["fx.stamina"]             = "Stamina",
                ["fx.shiplock"]            = "Ship locked",
                ["fx.speed"]               = "Fast & Serious",
                ["fx.micmute"]             = "Mic muted",
                ["fx.soundmute"]           = "Sound muted",
                ["fx.sale"]                = "Sale",
                ["fx.berserk"]             = "Berserk",
            ...
            _strings[Lang.French] = new Dictionary<string, string>
            {
                ...
                ["chat.random_event"]  = "Évènement aléatoire lancé : {0}",
                ...
                ["fx.timefreeze"]          = "Temps figé",
                ["fx.stamina"]             = "Stamina",
                ["fx.shiplock"]            = "Vaisseau bloqué",
                ["fx.speed"]               = "Fast & Serious",
                ["fx.micmute"]             = "Micro coupé",
                ["fx.soundmute"]           = "Son coupé",
                ["fx.sale"]                = "Soldes",
                ["fx.berserk"]             = "Berserk",
